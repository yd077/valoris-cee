  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#121212] font-sans selection:bg-[#81B93E] selection:text-white overflow-x-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="max-w-4xl mx-auto text-center mb-16">
             <h2 className="text-3xl md:text-5xl font-serif font-bold leading-tight mb-6 text-[#121212] uppercase">
               RÉPONDEZ AUX ENJEUX ÉNERGÉTIQUES DE DEMAIN
             </h2>
      ...
      <section className="py-32 px-6 text-white text-center relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto relative z-10">
           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
             <h2 className="text-4xl md:text-6xl font-serif font-bold leading-tight mb-8">Des leviers à votre disposition</h2>
              ...
              <motion.div variants={fadeUp} className="flex items-start space-x-6 group">
                ...
                <div>
                  ...
                  <p className="text-xl font-medium text-[#121212]">
                    125 rue du chat botté<br/>01700 Beynost
                  </p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <form className="space-y-8" onSubmit={async (e) => {
                ...
                try {
                  ...
                  if (result.success) {
                    setSubmitStatus({ type: 'success', message: 'Votre message a bien été envoyé ! Il sera traité dans les plus brefs délais.' });
                    form.reset();
                  } else {
                    setSubmitStatus({ type: 'error', message: 'Erreur: ' + (result.error || 'Une erreur est survenue.') });
                  }
                } catch (error) {
                ...
                {submitStatus && (
                  <div className={`p-4 rounded-xl text-sm font-bold ${submitStatus.type === 'success' ? 'bg-[#81B93E]/10 text-[#81B93E] border border-[#81B93E]/20' : 'bg-red-50 text-red-600 border border-red-100'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input type="text" id="firstName" name="firstName" required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" placeholder="Jean" />
                  </div>
                  <div className="space-y-3">
                    <label htmlFor="lastName" className="text-sm font-bold uppercase tracking-wider text-gray-500">Nom</label>
                    <input type="text" id="lastName" name="lastName" required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" placeholder="Dupont" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input type="email" id="email" name="email" required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" placeholder="jean.dupont@email.com" />
                  </div>
                  <div className="space-y-3">
                    <label htmlFor="phone" className="text-sm font-bold uppercase tracking-wider text-gray-500">Téléphone</label>
                    <input type="tel" id="phone" name="phone" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" placeholder="04 58 28 03 24" />
                  </div>
                </div>

                <div className="space-y-3">
                  <label htmlFor="subject" className="text-sm font-bold uppercase tracking-wider text-gray-500">Sujet</label>
                  <select id="subject" name="subject" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 appearance-none">
                ...
                <div className="space-y-3">
                  ...
                  <textarea id="message" name="message" required rows={5} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-6 py-4 text-[#121212] focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 resize-none" placeholder="Décrivez votre projet ou votre besoin..."></textarea>
                </div>
      ...
      <footer className="bg-[#121212] text-white py-20 px-6 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 relative z-10 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-4 font-medium text-gray-400">
              <li><a href="mailto:contact@valoris-energy.fr" className="hover:text-blue-400 transition-colors">contact@valoris-energy.fr</a></li>
              <li>125 rue du chat botté<br/>01700 Beynost</li>
            </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-gray-500 font-medium text-sm relative z-10">
          <p>&copy; {new Date().getFullYear()} Valoris Energy. Tous droits réservés.</p>
          <div className="space-x-8 mt-6 md:mt-0">
            ...
            <Link to="/politique-confidentialite" className="hover:text-blue-400 transition-colors">Politique de confidentialité</Link>
          </div>
        </div>
      </footer>
    </div>
